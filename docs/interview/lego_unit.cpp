...
void port_vector_print (vector<port_t *> *port_vector)
{
...
void process_connection (string start_name,
...
void process_value (string always_input,
               string index_string,
               string value_string)
{
...
int main ()
{
    ...
    input_parser_c little_parser = input_parser_c ();
